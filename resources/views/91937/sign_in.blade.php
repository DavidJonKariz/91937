            ...
            <div class="inner-login-panel">
                <div class="content-panel">
                    ...
                    <form method="post" action="/student/login">
                        ...
                        <input type="submit" value="LOGIN" name="submit" style="background-color: #51326a; color: white; font-family: Josefin Sans, sans-serif;">
                    </form>
                </div>
            </div>
        </div>
...
<style>
    ...
    .login-screen .right-item {
        ...
        background-image: url(https://www.popsci.com/sites/popsci.com/files/images/2017/11/books.jpg);
        /*https://www.popsci.com/sites/popsci.com/files/images/2017/11/books.jpg*/
